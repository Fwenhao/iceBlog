...
export default {
  ...
  methods: {
    ...
    getArticle(articleId) {
      ...
      .then(({ data }) => {
        if (data && data.code === 1) {
          ...
          let articleTags = this.article.tags;
          ...
          this.$nextTick(function () {
            ...
            document.title = this.article.title + " | Ice Blog ";
          });
        }
      });
    },
    ...
    showCommentById(articleId) {
      this.$axios.get("/comment/getlist?articleId=" + articleId)
      .then(({ data }) => {
